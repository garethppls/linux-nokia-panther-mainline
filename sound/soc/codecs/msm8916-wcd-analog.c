...
#define CDC_A_MICB_2_PULL_UP_EN_MASK	BIT(6)
#define CDC_A_MICB_2_PULL_UP_EN		BIT(6)
...
static int pm8916_wcd_analog_enable_micbias_int(struct snd_soc_dapm_widget
