...
static struct clk_alpha_pll gpll0_sleep_clk = {
	.offset = 0x21000,
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			.name = "gpll0_sleep_clk",
			.parent_data = &(const struct clk_parent_data) {
				.fw_name = "xo",
			},
			.num_parents = 1,
			.ops = &clk_alpha_pll_sleep_vote_ops,
		},
	},
};
...
static const struct clk_parent_data gcc_xo_gpll0_gpll6_data[] = {
	{ .fw_name = "xo" },
	{ .hw = &gpll0.clkr.hw },
	{ .hw = &gpll6.clkr.hw },
};
...
static struct clk_rcg2 jpeg0_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data){
		.name = "jpeg0_clk_src",
		.parent_data = gcc_xo_gpll0_gpll6_data,
		.num_parents = ARRAY_SIZE(gcc_xo_gpll0_gpll6_data),
		.ops = &clk_rcg2_ops,
	},
};
...
static const struct clk_parent_data gcc_cci_esc_vsync_data[] = {
	{ .fw_name = "xo" },
	{ .hw = &gpll0.clkr.hw },
};
...
static struct clk_rcg2 cci_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data){
		.name = "cci_clk_src",
		.parent_data = gcc_cci_esc_vsync_data,
		.num_parents = ARRAY_SIZE(gcc_cci_esc_vsync_data),
		.ops = &clk_rcg2_ops,
	},
};
...
static const struct parent_map gcc_sdcc1_map[] = {
	{ P_XO, 0 },
	{ P_GPLL0, 1 },
	{ P_GPLL4, 2 },
	{ P_GPLL6, 3 },
...
static const struct clk_parent_data gcc_sdcc1_data[] = {
	{ .fw_name = "xo" },
	{ .hw = &gpll0.clkr.hw },
	{ .hw = &gpll4.clkr.hw },
	{ .hw = &gpll6.clkr.hw },
...
static struct clk_rcg2 sdcc1_apps_clk_src = {
	...
	.mnd_width = 8,
	.hid_width = 5,
	.parent_map = gcc_sdcc1_map,
	.freq_tbl = ftbl_sdcc1_apps_clk_src,
	.clkr.hw.init = &(struct clk_init_data){
		.name = "sdcc1_apps_clk_src",
		.parent_data = gcc_sdcc1_data,
		.num_parents = ARRAY_SIZE(gcc_sdcc1_data),
		.ops = &clk_rcg2_floor_ops,
	},
};
...
static struct clk_regmap *gcc_msm8937_clocks[] = {
	[GPLL0_SLEEP] = &gpll0_sleep_clk.clkr,
...
{
	/* GPLL3 930MHz configuration */
	gpll3_config.l = 0x30;
	gpll3.vco_table = gpll3_vco_msm8917;
	gpll3.num_vco = ARRAY_SIZE(gpll3_vco_msm8917);

	/*
	 * Set below clocks for use specific msm8917 freq table.
	 */
	...
	vcodec0_clk_src.parent_map = gcc_vfe_map;
	...
	/*
	 * Below clocks are not available on msm8917.
	 */
